...
- Reader ApplicationDisplayVersion: 0.2.3
- Reader ApplicationVersion / Android versionCode: 11
- Wear ApplicationDisplayVersion: 0.2.1
- Wear ApplicationVersion / Android versionCode: 9（同じpackage name・署名を使用）
